...
my %state = ( 
	      ...
	      'StandAlone' => { 'value' => 'CRITICAL', 'type' => 'cs' },
	      ...
	      'Inconsistent' => { 'value' => 'WARNING', 'type' => 'ld' },
              # DRBD 8.0
	      ...
	      'Outdated' => { 'value' => 'WARNING', 'type' => 'ds' },
	      'Inconsistent' => { 'value' => 'WARNING', 'type' => 'ds' },
